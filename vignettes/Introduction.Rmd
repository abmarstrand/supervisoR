...
default_data <- load_default_data(database="GO", species = "Homo sapiens")
...
```{r}
# Generate example dataset. Note that the example data is randomly generated using rnorm(length(gene_sets), sd = 0.25)
...
#parent_name <- "Protein Localization To Cell Surface" #GO
