...
exactSource_to_name <- preprocessed_data$exactSource_to_name
...
## Plotting Connected Top-Level Pathways with Overlap Filtering
Visualize a network of top-level pathways connected based on gene overlap, allowing you to focus on pathways sharing significant gene sets.

```{r}
# Plotting a connected top-level pathway with other pathways sharing at least 10 genes
# plot_subgraph(
...
## Plotting Connected Top-Level Pathways Relative to a Reference Condition
Combine overlap filtering with relative enrichment to analyze pathways in the context of a reference condition.
